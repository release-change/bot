# Contributing to @release-change/bot

Thank you for your interest and efforts to contribute to @release-change/bot. All work done is available on GitHub.
...
@release-change/bot is using [GitHub issues](https://github.com/release-change/bot/issues) to manage feature requests and bugs. Before opening an issue or a pull request, try to ensure your problem or feature request has not been already reported or fixed.

### Feature requests

Feature requests by the community are highly encouraged. Feel free to submit a new one filling the information requested in the [feature request template](https://github.com/release-change/bot/issues/new?template=feature-request.yml).

### Bug reports

Please try to be as detailed as possible in your report and fill the information requested in the [bug report template](https://github.com/release-change/bot/issues/new?template=bug-report.yml).
...
#### Steps
1. [Go to the repository](https://github.com/release-change/bot) and fork it using your own GitHub account,
2. clone your repository:

        git clone git@github.com:YOUR_USERNAME/bot.git
3. go to the root of the repository and run:

        cd @release-change/bot
        pnpm install
4. run TypeScript and the test suites in watch mode:

        pnpm dev

Awesome! You are now able to contribute to @release-change/bot.
...
@release-change/bot follows the rules defined by the [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) specification.
...
@release-change/bot uses [commitlint](https://commitlint.js.org) to help you create valid commit messages.
...
@release-change/bot uses [Biome](https://biomejs.dev) for linting and formatting. Biome linting and formatting will be automatically checked and run when committing.
...
@release-change/bot uses [Vitest](https://vitest.dev) for writing and running tests.
