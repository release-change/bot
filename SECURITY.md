...
The latest version of bot is currently supported with security updates.
...
Please report (suspected) security vulnerabilities via [GitHub’s security advisory reporting system](https://github.com/release-change/bot/security/advisories/new).
...
bot does not support other reporting platforms: all security vulnerabilities must be made via the GitHub Advisory system.

List of some (though not all) platforms **which are not supported:**
- direct e-mail or communication to bot contributors (Discord or Slack),
- Stack Overflow.
